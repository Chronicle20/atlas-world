...
func allProvider(tenant tenant.Model) model.Provider[[]Model] {
	return func() ([]Model, error) {
		return GetChannelRegistry().ChannelServers(tenant.Id.String()), nil
	}
}

func byWorldProvider(_ logrus.FieldLogger, tenant tenant.Model) func(worldId byte) model.Provider[[]Model] {
